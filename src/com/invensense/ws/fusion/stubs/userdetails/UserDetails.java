...
@XmlType(name = "UserDetails", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", propOrder = {
    "personId",
    "personNumber",
    "userId",
    "username",
...
public class UserDetails {
    ...
    @XmlElementRef(name = "Username", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> username;
    @XmlElementRef(name = "UserGUID", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> userGUID;
    @XmlElement(name = "ActiveFlag")
    protected Boolean activeFlag;
    @XmlElementRef(name = "CredentialsEmailSent", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> credentialsEmailSent;
    @XmlElementRef(name = "UserDistinguishedName", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    ...
    public void setCredentialsEmailSent(JAXBElement<String> value) {
        this.credentialsEmailSent = value;
    }
