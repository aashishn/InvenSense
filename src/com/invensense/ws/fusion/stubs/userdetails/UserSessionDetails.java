...
@XmlType(name = "UserSessionDetails", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", propOrder = {
    "personId",
    "language",
    "dateFormat",
    "timeFormat",
...
public class UserSessionDetails {
    ...
    @XmlElementRef(name = "Language", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> language;
    @XmlElementRef(name = "DateFormat", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> dateFormat;
    @XmlElementRef(name = "TimeFormat", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> timeFormat;
    @XmlElementRef(name = "NumberFormat", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> numberFormat;
    @XmlElementRef(name = "Currency", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> currency;
    @XmlElementRef(name = "GroupingSeparator", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> groupingSeparator;
    @XmlElementRef(name = "DecimalSeparator", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> decimalSeparator;
    @XmlElementRef(name = "TimeZone", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> timeZone;
    @XmlElementRef(name = "ClientEncoding", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> clientEncoding;
    @XmlElementRef(name = "Territory", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> territory;
    @XmlElementRef(name = "FontSize", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> fontSize;
    @XmlElementRef(name = "AccessibilityMode", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> accessibilityMode;
    @XmlElementRef(name = "ColorContrast", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> colorContrast;
    @XmlElementRef(name = "ServerTime", namespace = "http://xmlns.oracle.com/apps/hcm/people/roles/userDetailsServiceV2/", type = JAXBElement.class, required = false)
