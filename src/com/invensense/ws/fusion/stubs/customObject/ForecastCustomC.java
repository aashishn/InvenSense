...
public class ForecastCustomC {
    ...
    @XmlElementRef(name = "ParentEndCustomer_Id_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> parentEndCustomerIdC;
    @XmlElementRef(name = "ParentEndCustomer_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
