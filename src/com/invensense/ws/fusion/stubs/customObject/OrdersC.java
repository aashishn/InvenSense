...
public class OrdersC {
    ...
    @XmlElementRef(name = "SoldToCustomer_Id_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<BigDecimal> soldToCustomerIdC;
    @XmlElementRef(name = "SoldToCustomer_c", namespace = "/oracle/apps/sales/custExtn/views/common/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> soldToCustomerC;
     ...
     *     
     */
    public JAXBElement<BigDecimal> getSoldToCustomerIdC() {
     ...
     *     
     */
    public void setSoldToCustomerIdC(JAXBElement<BigDecimal> value) {
     ...
     *     
     */
    public JAXBElement<String> getSoldToCustomerC() {
     ...
     *     
     */
    public void setSoldToCustomerC(JAXBElement<String> value) {
