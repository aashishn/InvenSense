...
@XmlRootElement(name="CustomObject5")
@XmlAccessorType(XmlAccessType.NONE)
@Entity(name="FORECAST")
@IdClass(ForeCastKey.class)
public class ForeCast extends BaseModel {
	...
	@Column(name = "closed", columnDefinition = "tinyint")
	...
	public String toString() {
		return "[Forecast] Parent End Customer Name : " + parentEndCustomerName + " , Part Number : " + partNumber + " , Market : " + market +
				" , Sub-Market : " + subMarket +  " , Business Unit" + businessUnit + " , Program Name : " + programName + " , Year : " + year;
	}
