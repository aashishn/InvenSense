...
@Service
public class SyncFinanceForecastPostNovember extends AbstractSyncFinanceForecast {
	
	private Logger log = Logger.getLogger(SyncFinanceForecastPostNovember.class);
