...
@Service
public class SyncFinanceForecastPostDecember extends AbstractSyncFinanceForecast {
	
	private Logger log = Logger.getLogger(SyncFinanceForecastPostDecember.class);
