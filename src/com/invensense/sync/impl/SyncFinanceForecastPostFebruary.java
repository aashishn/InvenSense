...
@Service
public class SyncFinanceForecastPostFebruary extends AbstractSyncFinanceForecast {
	
	private Logger log = Logger.getLogger(SyncFinanceForecastPostFebruary.class);
	...
	public void syncFinanceForecastFromHistory(ForeCast salesForecast, FinanceForeCastHistory financeForeCastHistory) throws Exception {
		...
		financeForeCast.setAsp11(financeForeCastHistory.getAsp11());
		financeForeCast.setAsp12(salesForecast.getAsp12());
		...
		financeForeCast.setQuantity11(financeForeCastHistory.getQuantity11());
		financeForeCast.setQuantity12(salesForecast.getQuantity12());
