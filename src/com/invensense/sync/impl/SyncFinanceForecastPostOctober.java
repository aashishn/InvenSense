...
@Service
public class SyncFinanceForecastPostOctober extends AbstractSyncFinanceForecast {
	
	private Logger log = Logger.getLogger(SyncFinanceForecastPostOctober.class);
