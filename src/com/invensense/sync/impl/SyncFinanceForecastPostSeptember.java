...
@Service
public class SyncFinanceForecastPostSeptember extends AbstractSyncFinanceForecast {
	
	private Logger log = Logger.getLogger(SyncFinanceForecastPostSeptember.class);
